...
function routingLikeAPro(app) {
    app.route("/story").get(story_controller_1.getStories).post(story_controller_1.createStory).delete(story_controller_1.deleteStory);
    app.route("/stories").get(story_controller_1.searchStory);
