...
function routingLikeAPro(app) {
    app.route("/story").get(story_controller_1.searchStory).post(story_controller_1.createStory).delete(story_controller_1.deleteStory);
    ...
    app.route("/story/image").patch(story_controller_1.updateImageUrl);
    ...
    // Chapters routes too
    app.route("/chapter").get(chapter_controller_1.readChapter).post(chapter_controller_1.createChapter).delete(chapter_controller_1.deleteChapter);
